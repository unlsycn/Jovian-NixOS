...
with lib.kernel;
{
  ...
  "ARCH_STACKWALK" = yes;
  "STACKDEPOT" = yes;
  "STACKDEPOT_MAX_FRAMES" = freeform "64";
  "SBITMAP" = yes;
  "LWQ_TEST" = no;
  "FIRMWARE_TABLE" = yes;
  "UNION_FIND" = yes;
