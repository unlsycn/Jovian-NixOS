...
with lib.kernel;
{
  ...
  "ZSWAP_ZPOOL_DEFAULT" = freeform "zsmalloc";
  "ZSMALLOC" = yes;
  "ZSMALLOC_STAT" = no;
  ...
  "SND_HDA_SCODEC_COMPONENT" = module;
  ...
  "SND_HDA_INTEL_HDMI_SILENT_STREAM" = no;
  ...
  "ANDROID_BINDER_IPC_SELFTEST" = no;
  "LIBNVDIMM" = no;
  "DAX" = module;
  "DEV_DAX" = no;
  "DEV_DAX_HMEM" = no;
  ...
  "CRYPTO_ARCH_HAVE_LIB_BLAKE2S" = yes;
